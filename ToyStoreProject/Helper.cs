...
namespace ToyStoreProject
{
     class Helper
    {
      ...
      /*  public static string Path_Shopingcart()
        {
            string path = System.IO.Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.Personal), Helper.shopcart);
            return path;
        }*/
